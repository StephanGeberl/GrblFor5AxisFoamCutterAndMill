...
// =============================
// FoamCutter/Mill -> 4/5 linear axis
// =============================
#ifdef DEFAULTS_RAMPS_BOARD
  #define MICROSTEPS_AXIS1 16     // Microstepping = 1/4 pas
  #define STEP_REVS_AXIS1 200    // Moteurs à 200 pas par tour
  #define UNIT_PER_REV_AXIS1 8.0 // 2mm
  #define DEFAULT_AXIS1_STEPS_PER_UNIT (MICROSTEPS_AXIS1*STEP_REVS_AXIS1/UNIT_PER_REV_AXIS1) // 400
  #define MICROSTEPS_AXIS2 16     // Microstepping = 1/4 pas
  #define STEP_REVS_AXIS2 200    // Moteurs à 200 pas par tour
  #define UNIT_PER_REV_AXIS2 8.0 // 2mm
  #define DEFAULT_AXIS2_STEPS_PER_UNIT (MICROSTEPS_AXIS2*STEP_REVS_AXIS2/UNIT_PER_REV_AXIS2)
  ...
  #define DEFAULT_AXIS3_ACCELERATION (50.0*60*60) // 100*60*60 mm/min^2 = 100 mm/sec^2
  #define DEFAULT_AXIS1_MAX_TRAVEL 400.0 // mm
  #define DEFAULT_AXIS2_MAX_TRAVEL 170.0 // mm
  #define DEFAULT_AXIS3_MAX_TRAVEL 400.0 // mm
  #if N_AXIS > 3
    #define MICROSTEPS_AXIS4 16
    #define STEP_REVS_AXIS4 200
    #define UNIT_PER_REV_AXIS4 8.0
    ...
    #define DEFAULT_AXIS4_MAX_TRAVEL 170.0 // mm
    // #define DEFAULT_AXIS4_MAX_RATE 1440 // °/mn
    // #define DEFAULT_AXIS4_ACCELERATION (50.0*60*60) // 100*60*60 mm/min^2 = 100 mm/sec^2
    // #define DEFAULT_AXIS4_MAX_TRAVEL 360.0 // °
  #endif
  #if N_AXIS > 4
    #define MICROSTEPS_AXIS5 16
    #define STEP_REVS_AXIS5 200
    // Zahnriemen
    // #define UNIT_PER_REV_AXIS5 40.0
    // Trapezgewinde
    #define UNIT_PER_REV_AXIS5 8.0
    #define DEFAULT_AXIS5_STEPS_PER_UNIT (MICROSTEPS_AXIS5*STEP_REVS_AXIS5/UNIT_PER_REV_AXIS5)
    #define DEFAULT_AXIS5_MAX_RATE (STEP_MAX_FREQUENCY/DEFAULT_AXIS5_STEPS_PER_UNIT*SECONDS_PER_MINUTE)
  ...
  #define DEFAULT_HOMING_DIR_MASK 21 // move positive dir, A and Y reverse (Home on Top)
  #define DEFAULT_HOMING_FEED_RATE 100.0 // mm/min
  #define DEFAULT_HOMING_SEEK_RATE 500.0 // mm/min
  #define DEFAULT_HOMING_DEBOUNCE_DELAY 250 // msec (0-65k)
  #define DEFAULT_HOMING_PULLOFF 5.0 // mm
