      ...
      case 'M':
        ...
        switch(int_value) {
          ...
          case 88: case 89:
            ...
            switch(int_value) {
              case 88: gc_block.modal.modeselect = MODE_HOTWIRE_ENABLE; sys_mode = 0; system_set_exec_alarm(EXEC_ALARM_MACHINE_MODE_CHANGED); break;
              case 89: gc_block.modal.modeselect = MODE_MILL_ENABLE; sys_mode = 1; system_set_exec_alarm(EXEC_ALARM_MACHINE_MODE_CHANGED); break;
            }
            break;
          // =============================
